...
public class DbManager {
    ...
    public void createSessione(String id, String nome, TipoSessione tipoSessione, TipoScrutinio tipoScrutinio, String password, int elettori, Integer gestoreId){
        ...
        sessionManager.createSessione(id, nome, tipoSessione, tipoScrutinio, password, elettori, gestoreId);
    }
    ...
    public void openSessione(String id, Integer gestoreId){
        ...
        sessionManager.openSessione(id, gestoreId);
    }
    ...
    public void closeSessione(String id, Integer gestoreId){
        ...
        sessionManager.closeSessione(id, gestoreId);
    }
    ...
    public Gestore loginGestore(String username, String password){
        ...
        try{
            ...
            if(r1!=null){
                ...
                Gestore g = new Gestore(r1.getInt("id"), r1.getString("username"), r1.getString("password"), p);
                return g;
            }
        }catch(SQLException e){
                System.out.println(e.getMessage());
    ...
    public Elettore loginElettore(String username, String password){ 
        ...
        try{
            ...
            if(r1!=null){
                ...
                ResultSet r2 = state.executeQuery();
                Persona p = new Persona(r2.getString("codiceFiscale"), r2.getBoolean("sesso"), r2.getString("nome"), r2.getString("cognome"), r2.getDate("dataNascita"), r2.getString("luogoNascita"));
                Elettore e = new Elettore(r1.getInt("id"), r1.getString("username"), r1.getString("password"), p);
                return e;
            }
        }catch(SQLException e){
                System.out.println(e.getMessage());
    ...
    public List<Sessione> getSessioniGestore(String gestoreId){
        ...
        try{
            ...
            while(r1.next()){
                ...
                Gestore gestore = new Gestore(r2.getInt("id"), r2.getString("username"), r2.getString("password"), persona);
    ...
    //Restituisce una SchedaElettorale in base all'id della sessione.
    ...
    public List<Partito> getParty(String id){
    ...
    public List<Candidato> getCandidate(String id){
        ...
        try{
            ...
            if(r != null){
                ...
                state.setString(1, r.getString("persona"));
                ResultSet r1 = state.executeQuery();
                Persona persona = new Persona(r1.getString("codiceFiscale"), r1.getBoolean("sesso"), r1.getString("nome"), r1.getString("cognome"), r1.getDate("dataNascita"), r1.getString("luogoNascita"));
                
                query = "SELECT * FROM Partito WHERE id = ?";
                state = connection.prepareStatement(query);
                state.setString(1, r1.getString("partito"));
                r1 = state.executeQuery();
                Partito partito = new Partito(r1.getInt("id"), r1.getString("nome"), r1.getDate("dataFondazione"));
                
                Candidato c = new Candidato(r.getInt("id"), r.getString("ruolo"), persona, partito);
                candidati.add(c);
            }
        }catch(SQLException e){
                System.out.println(e.getMessage());
    ...
    //Permette di eseguire l'auditing ogni volta che viene eseguita un azione sul sistema.
